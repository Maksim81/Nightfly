...
class VisibleRegionDemoActivity :
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        ...
        map.apply{
            ...
            addMarker(MarkerOptions().position(FobHouseLatLng).title("Gamma Test Technologies"))
            // Add a camera idle listener that displays the current camera position in a TextView
            setOnCameraIdleListener {
                messageView.text = getString(R.string.about_demo_content)+getString(R.string.about_demo_content_field_testers)+getString(R.string.about_demo_content_special_thanks)
            }
        }
        ...
        operaHouseButton.setOnClickListener {
            map.moveCamera(CameraUpdateFactory.newLatLngZoom(FobHouseLatLng, 16f))
        }
